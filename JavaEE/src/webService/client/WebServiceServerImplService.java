 ...
 * 
 */
@WebServiceClient(name = "WebService_Server_ImplService", targetNamespace = "http://server.webService/", wsdlLocation = "http://localhost:8999/webservice_server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVERIMPLSERVICE_QNAME = new QName("http://server.webService/", "WebService_Server_ImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8999/webservice_server?wsdl");
     ...
     */
    @WebEndpoint(name = "WebService_Server_ImplPort")
    public WebServiceServerImpl getWebServiceServerImplPort() {
        return super.getPort(new QName("http://server.webService/", "WebService_Server_ImplPort"), WebServiceServerImpl.class);
    }
    ...
    public WebServiceServerImpl getWebServiceServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webService/", "WebService_Server_ImplPort"), WebServiceServerImpl.class, features);
    }
