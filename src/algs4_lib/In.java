...
public final class In {
   ...
   /**
     * Initializes an input stream from a SocketClient.
     *
     * @param  socket the SocketClient
     * @throws IllegalArgumentException if cannot open {@code SocketClient}
     * @throws IllegalArgumentException if {@code SocketClient} is {@code null}
     */
    public In(Socket socket) {
        if (socket == null) throw new IllegalArgumentException("SocketClient argument is null");
        try {
